...
function [EEG,art] = interface_ADJ_WithoutInterface (EEG,report)
...
%         EEGep = pop_rmbase( EEGep, [0  0]);
   ...
   [art, horiz, vert, blink, disc,...
    ...
    if isempty(EEG.icaact)
     ...
     EEG = pop_selectcomps_ADJ_WithoutInterface( EEG, 1:size(EEG.icaweights,1), art, horiz, vert, blink, disc,...
        soglia_DV, diff_var, soglia_K, med2_K, meanK, soglia_SED, med2_SED, SED, soglia_SAD, med2_SAD, SAD, ...
